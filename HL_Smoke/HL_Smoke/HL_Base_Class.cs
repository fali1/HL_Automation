...
namespace HL_Smoke
{
    public class HL_Base_Class
    {
        ...
        /*
        public void create_fax_receiver(string file_name)
        {
            string[] lines_local = read_from_file("hipadm_cmd");
            string[] receiver_cmd = read_from_file(file_name);
        ...
        public void create_voice_receiver(string file_name)
        {
            string[] lines_local = read_from_file("hipadm_cmd");
            string[] receiver_cmd = read_from_file(file_name);
        ...
        */
        ...
        public void create_messenger(string file_name)
        {
            string[] lines_local = read_from_file("hipadm_cmd");
            string[] messenger_cmd = read_from_file(file_name);
            ...
            //Create a File Path
            string BatFile = @".\add_messenger.bat";
            ...
            ps.CreateNoWindow = true;
            ps.UseShellExecute = true;
            ps.FileName = @".\add_messenger.bat"; // this batch file will be executed
            ps.Arguments = lines_local[0]; //this argument will be replaced by '%1' in batch file created bove
            p.StartInfo = ps;
            p.Start();
            p.WaitForExit();
