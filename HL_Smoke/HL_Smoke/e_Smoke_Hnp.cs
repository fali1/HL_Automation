    ...
    public class e_Smoke_Hnp
    {
        ...
        public void a_Hnp_Configuration()
        {
            ...
            if (driver.FindElement(By.XPath("//span[@class='c_f_info_text']")).Text.Equals("Yes"))
            {
                ...
                Assert.AreEqual("General Policy", driver.FindElement(By.XPath("//div[1]/div[3]/div/h1")).Text);
            
            
                driver.FindElement(By.XPath("//div[1]/div[3]/div/form/div[1]/div/fieldset/label/span")).Click();
            
                Thread.Sleep(1000);
            
            
                driver.FindElement(By.XPath("//div/fieldset[1]/div/a[2]")).Click();
                ...
                Assert.AreEqual("Activation", driver.FindElement(By.XPath("//div[1]/div[3]/div/h1")).Text);
