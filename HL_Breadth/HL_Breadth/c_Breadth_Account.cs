    ...
    public class c_Breadth_Account
    {
        ...
        public void c_Add_Edit_Delete_Response_Action()
        {
            ...
            else
            {
                ...
                if (!(driver.FindElement(By.XPath("//div[@id='divGrid_idGridDataNode']")).Text.Contains(response_action_name_2)))
                {
                ...
                else
                {
                    ...
                    if (!(driver.FindElement(By.XPath("//div[@id='divGrid_idGridDataNode']")).Text.Contains(response_action_name_2_edited)))
                    {
