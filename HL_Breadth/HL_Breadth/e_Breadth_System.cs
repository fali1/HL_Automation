...
{
    [TestFixture]
    public class e_Breadth_System : HL_Base_Class
    {
    ...
    //    string browser_name;
         ...
         //   string server_port = "1337";
                ...
                driver.FindElement(By.XPath(".//*[@id='emailPanel']/div/div[4]/div/div[2]/fieldset[1]/span")).Text.Contains(standard_send_pattern))
            {
                    ...
                    driver.FindElement(By.XPath(".//*[@id='POP']/div/div[1]/div[4]/fieldset/span")).Text.Contains(pop_two_acc))
                {
                    ...
                    takescreenshot("Email_Gateway_service");
        ...
        public void c_Backup_Settings_Panel()
        {
           // string backup_dir = @"C:\HipLink\backup";
                    ...
                    driver.FindElement(By.XPath("//*[@id='lblBackupHours']")).Text.Contains("2"))
            {
                ...
                takescreenshot("Backup_setting_service");
        ...
        public void d_Snpp_Gateway()
        {
            ...
            if (driver.FindElement(By.XPath("//*[@id='lblAuth']")).Text.Equals(NoAuth))
            {
                    ...
                    driver.FindElement(By.Id("lblTimeout")).Text.Equals(timeout))
                {
                    ...
                    takescreenshot("SNPP_Gateway_service");
        ...
        public void e_Add_Tap_Gateway()
        {
            ...
            else
            {
                ...
                takescreenshot("TAP_Gateway_service");
        ...
        //    driver.FindElement(By.XPath("//*[@id='3']")).Click();
            ...
            driver.FindElement(By.XPath("//h5[text()='Message Backed-Up']")).Click();          
            Thread.Sleep(1000);
            ...
            driver.FindElement(By.XPath("//li[text()='" + response_action_name + "']")).Click();

            Thread.Sleep(2000);

            takescreenshot("Feedback_Action");

            Assert.AreEqual(true,driver.FindElement(By.XPath("//ul[@id='eventsList']/li[1]/span")).Text.Equals("1"));

                
            driver.FindElement(By.XPath("//h5[text()='Message Completed']")).Click();
            Thread.Sleep(1000);
            ...
            Assert.AreEqual(true, driver.FindElement(By.XPath("//ul[@id='eventsList']/li[2]/span")).Text.Equals("1"));
            
            Console.WriteLine("Feedback Action Passed");

            driver.FindElement(By.XPath("//h5[text()='Message Backed-Up']")).Click();

            driver.FindElement(By.XPath("//fieldset/label[@class='chk_box']/span[@class='custom checkbox']")).Click();
            Thread.Sleep(2000);
